...
export const MALE_CALORIES_BURN_RATE_SECOND =
  MALE_CALORIES_BURN_RATE_DAY / CORE_CONSTANTS.DAY_DURATION;
export const FEMALE_CALORIES_BURN_RATE_DAY = 2000;
export const FEMALE_CALORIES_BURN_RATE_SECOND =
  FEMALE_CALORIES_BURN_RATE_DAY / CORE_CONSTANTS.DAY_DURATION;
export const MALE_INITIAL_CALORIES =
  MAX_DAYS_WITHOUT_FOOD * MALE_CALORIES_BURN_RATE_DAY;
export const FEMALE_INITIAL_CALORIES =
  MAX_DAYS_WITHOUT_FOOD * FEMALE_CALORIES_BURN_RATE_DAY;
...
export const MALE_HYDRATION_BURN_RATE_SECOND =
  MALE_HYDRATION_BURN_RATE_DAY / CORE_CONSTANTS.DAY_DURATION;
export const FEMALE_HYDRATION_BURN_RATE_DAY = 2500;
export const FEMALE_HYDRATION_BURN_RATE_SECOND =
  FEMALE_HYDRATION_BURN_RATE_DAY / CORE_CONSTANTS.DAY_DURATION;
export const MALE_INITIAL_HYDRATION =
  MAX_DAYS_WITHOUT_WATER * MALE_HYDRATION_BURN_RATE_DAY;
export const FEMALE_INITIAL_HYDRATION =
  MAX_DAYS_WITHOUT_WATER * FEMALE_HYDRATION_BURN_RATE_DAY;
